...
export const THEME_CARD_TEMPLATES: Record<
  DistressTheme,
  { understanding: string; understandingDetail: string; action: string; actionItemId: string; help: string }
> = {
  academic: {
    understanding: '你最近的辛苦，我都听到了。不是你不够好，是你太累了。',
    understandingDetail:
      '我能感受到你一直在撑着——每天面对那么多压力，要跟上进度，要面对期待，还要和自己内心的焦虑较劲。这些真的很不容易。\n\n你知道吗？觉得累不是因为你不够努力，恰恰是因为你太努力了。就像一根橡皮筋拉得太久会失去弹性一样，你的心也需要休息的时间。\n\n你不用每时每刻都在"状态里"。允许自己有学不进去的时候，允许自己偶尔考不好，允许自己不是那个最优秀的人——这些都不会让你变得不好。你本身的价值，从来不是用分数来衡量的。\n\n今天先放一放吧。去喝杯热的，看看窗外，或者就单纯地发会儿呆。你已经做得很好了，真的。',
  ...
  selfDoubt: {
    ...
    understandingDetail:
      '我听到了你对自己的那些评价：不够好、不够努力、不够优秀……这些话你一定在心里对自己说了很多遍了，对吗？\n\n我想请你做一个小实验：如果是你最好的朋友对你说这些话，你会怎么回应他？你会告诉他"你真的很差劲"吗？还是会心疼他，想抱抱他，告诉他"不是这样的，你已经很好了"？\n\n为什么我们对别人可以那么宽容，对自己却那么苛刻呢？\n\n你说自己不够好，但你有没有想过——你对"好"的标准，是不是定得太高了？你不需要成为完美的人，你只需要是你自己。你有你的感受，你的思考，你独特的样子。这些加在一起，就是值得被喜欢的你。\n\n下次那个批评的声音再出现时，试着对自己说："我知道你在担心，但没关系，我接受现在这样的自己。"',
  ...
  interpersonal: {
    ...
    understandingDetail:
      '被排斥、被孤立的感觉一定很难受吧——好像自己是多余的，好像无论怎么做都融不进去。那种孤独和委屈，我能感受到。\n\n但我想告诉你：这真的不是你的错。\n\n有时候人们会因为不了解而疏远，有时候会因为害怕"不一样"而抱团，还有时候，只是因为你们刚好不是一类人。这些都和你好不好、值不值得被喜欢没有关系。\n\n你知道吗？真正好的关系，是不需要你费力去讨好、去改变自己的。你可以放松地做你自己，可以说想说的话，可以有自己的想法，对方依然会觉得你很好。\n\n如果现在身边没有这样的人，也没关系。这世上有很多很多人，总会有和你同频的。你现在要做的，不是逼自己融入不适合的圈子，而是好好照顾自己，等待那些对的人出现。\n\n你值得被真诚地对待。在那之前，先好好对待自己。',
  ...
  lifeConfusion: {
    ...
    understandingDetail:
      '"这样活着有什么意义呢？"\n\n我想，会问出这个问题的你，一定是个很认真的人——你不愿意浑浑噩噩地过，你想要找到真正值得投入的事情。这本身就很珍贵。\n\n但我也想和你分享一个想法：意义不一定是一个大答案，等着我们在某个地方找到它。更多时候，意义是在一件件小事中慢慢"长"出来的。\n\n比如，你今天喝了一杯温度刚好的水，那一刻的舒服感；你偶然听到一首喜欢的歌，嘴角不自觉上扬的瞬间；你看到路边一只猫伸懒腰，觉得它好可爱。这些都是"活着"的小证据。\n\n它们很小，很不起眼，但它们是真实的。\n\n不用急着找到那个"终极答案"。先从感受今天开始：今天吃的饭是什么味道？风吹在脸上是什么感觉？有没有哪一个瞬间，你觉得"还不错"？\n\n慢慢来。你不需要立刻知道人生的方向。你只需要知道，今天的你，是被认真对待的。',
  ...
  academicAnxiety: {
    ...
    understandingDetail:
      '我知道那种感觉——心跳加快，脑子里乱糟糟的，好像有很多事情要做但又不知道从哪开始，甚至会觉得喘不过气来。这种焦虑的感觉真的很不舒服。\n\n但你知道吗？焦虑不全是坏事。它其实是你的身体在告诉你："这件事对你很重要，你需要认真对待。"只是有时候，这个提醒有点太大声了，反而让我们没法好好做事。\n\n试着做一个小小的练习：现在，把注意力放到你的呼吸上。不用改变它，只是感受它——空气是怎么进入鼻子的，又是怎么呼出来的。如果脑子里还有很多想法，没关系，注意到它们，然后轻轻把注意力带回到呼吸上。\n\n就这么做三次呼吸。\n\n你看，你可以做到的。\n\n焦虑不是你的敌人，它只是一个有点急的朋友。你可以对它说："我听到你了，谢谢你提醒我。现在，让我先深呼吸一下，然后一件一件来。"\n\n你不需要一下子做完所有事。你只需要从眼前最小的那一步开始。',
...
export const NEUTRAL_CARD_TEMPLATE = {
  ...
  understandingDetail:
    '谢谢你愿意把今天的心情写在这里。\n\n也许今天没有什么特别的事情发生，就是平平常常的一天。也许你会觉得"这样的日子没什么好记录的"。但我想告诉你：平淡的日子也是生活的一部分，也值得被看见。\n\n你知道吗？能安安稳稳地度过一天，本身就是一种幸运。没有大起大落，没有惊涛骇浪，就只是普通地活着——这其实是很多人求而不得的。\n\n今天的你，有没有哪一个瞬间觉得"还不错"？比如吃到好吃的东西，看到好看的云，或者只是某个时刻心里很平静。\n\n如果有，把那个瞬间记下来吧。等以后回头看，你会发现，原来自己的生活里，有这么多小小的、温柔的时刻。\n\n谢谢你今天也在认真生活。你做得很好。',
  action: '在熟悉的路上慢慢走一遍，试着找三样以前没注意过的东西。',
  actionItemId: 'act2',
...
export function buildCardRecommendation(
  ...
  const understanding: SupportCard = {
    ...
    detail: tmpl.understandingDetail,
  };
